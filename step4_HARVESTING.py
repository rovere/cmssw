...
# with command line options: step4 --conditions 92X_dataRun2_Prompt_v2 -s HARVESTING:@trackingOnlyDQM --era Run2_2017 --filein file:step3_inDQM.root --scenario pp --filetype DQM --geometry DB:Extended --mc -n 100 --fileout file:step4.root
...
process.DQMHarvestTracking_step = cms.Path(process.PixelOfflineDQMClientNoDataCertification+process.DQMHarvestTracking)
process.dqmsave_step = cms.Path(process.DQMSaver)

# Schedule definition
process.schedule = cms.Schedule(process.DQMHarvestTracking_step,process.dqmsave_step)
