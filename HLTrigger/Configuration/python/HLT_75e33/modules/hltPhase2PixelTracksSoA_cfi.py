...
layers = [
    ...
    [    28,     True,  0.25,   0.003,    True],
    [    29,     True,  0.25,   0.003,    True],
    [    30,     True,  0.25,   0.003,    True],
    [    31,     True,  0.25,   0.003,    True],
    [    32,     True,  0.25,   0.003,    True],
    [    33,     True,  0.25,   0.003,    True],
    [    34,     True,  0.25,   0.003,    True],
    [    35,     True,  0.25,   0.003,    True],
    [    36,     True,  0.25,   0.003,    True],
    [    37,     True,  0.25,   0.003,    True],
    [    38,     True,  0.25,   0.003,    True],
    [    39,     True,  0.25,   0.003,    True],
]
...
layerPairsFullOT.extend([
    ...
    [ 31, 32, False,   1250,  -1200,   1200,  -10000,   10000, 10000,    -15,    1.5,  0.85,   15.0],
