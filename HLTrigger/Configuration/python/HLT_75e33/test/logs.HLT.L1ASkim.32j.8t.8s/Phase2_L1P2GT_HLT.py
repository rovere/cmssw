...
# with command line options: Phase2 -s L1P2GT,HLT:75e33_timing --processName=HLTX --conditions auto:phase2_realistic_T33 --geometry Extended2026D110 --era Phase2C17I13M9 --customise SLHCUpgradeSimulations/Configuration/aging.customise_aging_1000 --eventcontent FEVTDEBUGHLT --filein=file:/data/user/rovere/store/relval/CMSSW_14_1_0_pre6/RelValMinBias_14TeV/GEN-SIM-DIGI-RAW/PU_141X_mcRun4_realistic_v1_STD_2026D110_PU-v3/output_Phase2_L1ASkim_merged.root --mc --nThreads 8 --inputCommands=keep *, drop *_hlt*_*_HLT, drop triggerTriggerFilterObjectWithRefs_l1t*_*_HLT -n 1000 --no_exec --output={}
...
process.options = cms.untracked.PSet(
    ...
    numberOfConcurrentLuminosityBlocks = cms.untracked.uint32(10),
