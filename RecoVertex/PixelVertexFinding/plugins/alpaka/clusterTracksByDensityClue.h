#ifndef RecoVertex_PixelVertexFinding_plugins_alpaka_clusterTracksByDensityClue_h
#define RecoVertex_PixelVertexFinding_plugins_alpaka_clusterTracksByDensityClue_h
...
namespace ALPAKA_ACCELERATOR_NAMESPACE::vertexFinder {
  ...
  class ClusterTracksByDensityClueKernel {
  public:
...
#endif  // RecoVertex_PixelVertexFinding_plugins_alpaka_clusterTracksByDensityClue_h
