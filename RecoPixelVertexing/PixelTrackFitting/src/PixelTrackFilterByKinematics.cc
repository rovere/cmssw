...
PixelTrackFilterByKinematics::PixelTrackFilterByKinematics(float optmin, float invPtTolerance, float tipmax, float tipmaxTolerance, float chi2max):
  theoPtMin(optmin), theNSigmaInvPtTolerance(invPtTolerance),
  theTIPMax(tipmax), theNSigmaTipMaxTolerance(tipmaxTolerance),
  theChi2Max(chi2max)
{}
